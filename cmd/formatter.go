...
func PrintTXTDiarizedTranscription(response gladia.TranscriptionResult) {
...
func PrintTableTranscription(response gladia.TranscriptionResult) {
...
func PrintJSONTranscription(response gladia.TranscriptionResult) {
...
func PrintJSONSimplifiedTranscription(response gladia.TranscriptionResult) {
...
func PrintCSVTranscription(response gladia.TranscriptionResult) {
...
func PrintSRTTranscription(response gladia.TranscriptionResult) {
...
func PrintSRTDiarizedTranscription(response gladia.TranscriptionResult) {
	for i, utterance := range response.Result.Transcription.Utterances {
		// Convert start and end times from seconds to SRT time format
		startTime := secondsToSRTTimeFormat(utterance.Start)
		endTime := secondsToSRTTimeFormat(utterance.End)
...
func PrintVTTTranscription(response gladia.TranscriptionResult) {
...
func PrintVTTDiarizedTranscription(response gladia.TranscriptionResult) {
...
func PrintSummarization(response gladia.TranscriptionResult) {
